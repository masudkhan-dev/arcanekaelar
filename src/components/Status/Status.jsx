...
const Status = () => {
  return (
    <section className="bg-[#F1F3F6] font-t py-7">
      <div className="border-t-8 border-dashed border-[#06223f31] pt-2"></div>

      {/* Title */}
      <header className="bg-[#F1F3F6] pt-8">
                  ...
                  <div>
                    <div className="page w-72 md:w-96 h-32 md:h-40 flex justify-center items-center shadow-xl my-8">
                      ...
                      <div className="flex flex-col justify-center items-start gap-2">
                        ...
                        <p>
                          নিজেকে ভালোবাসুন, নিজেকে ভালোবাসতে না পারলে আমাকে
                          ভালোবাসুন!
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="page w-72  md:w-96 h-32 md:h-40 flex justify-center items-center shadow-xl my-5">
                      ...
                      <div className="flex flex-col justify-center items-start gap-2">
                        <FaQuoteLeft className="text-[#06223f31] text-3xl" />
                        <p className="font-t">
                          All of the city lights,💡 <br /> Never shine as bright
                          as your eyes. 👁️
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="page w-72  md:w-96 h-32 md:h-40 flex justify-center items-center shadow-xl my-5 mr-10">
                      ...
                      <div className="flex flex-col justify-center items-start gap-2">
                        <FaQuoteLeft className="text-[#06223f31] text-3xl" />
                        <p className="font-t">
                          Don't compare yourself with others, <br />- Everyone
                          is better than you...✌️
                        </p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <div className="page w-72  md:w-96 h-32 md:h-40 flex justify-center items-center shadow-xl my-5 mr-10">
                      ...
                      <div className="flex flex-col justify-center items-start gap-2">
                        <FaQuoteLeft className="text-[#06223f31] text-3xl" />
                        <p>
                          ক্ষুধা না লাগলে,🍚 <br />- হয়তো কেউই কোনো কাজ করত
                          না!😐
                        </p>
                      </div>
                    </div>
